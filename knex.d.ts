...
// Original Definitions  by: Qubo <https://github.com/tkQubo>
...
declare namespace Knex {
  ...
  interface Raw extends ExecutionInterface {
  ...
  //
  // Execution interface - does not return query build so these are the end of the line
  //
  ...
  interface ExecutionInterface extends Promise<any> {
    ...
    on(eventName: string, callback: Function): PromiseReadWriteStream;
  }
